...
public class WAStoragePublisher extends Recorder {
	...
	public WAStoragePublisher(final String storageAccName,
			...
			final boolean cleanUpContainer, final boolean allowAnonymousAccess, final String metaData) {
		super();
	...
	public boolean perform(AbstractBuild<?, ?> build, Launcher launcher,
        ...
        // Resolve metadata
		String expMetaData = Utils.replaceTokens(build, listener, metaData);
        
        if (expMetaData != null) {
			expMetaData = expMetaData.trim();
		}
